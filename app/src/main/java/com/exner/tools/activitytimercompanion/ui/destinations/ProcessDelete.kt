...
import com.exner.tools.activitytimercompanion.ui.ProcessDeleteViewModel
...
fun ProcessDelete(
    ...
    val processDeleteViewModel = hiltViewModel<ProcessDeleteViewModel, ProcessDeleteViewModel.ProcessDeleteViewModelFactory> { factory ->
